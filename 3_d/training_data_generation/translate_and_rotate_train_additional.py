...
y=data[:,1]
z=data[:,2]
f=open('additional_training_data_0_0.5.dat','w')
...
for i in range(0,10000000):
    ...
    dist_x1=np.random.uniform(0,0.5)
    dist_y1=np.random.uniform(0,0.5)
    dist_z1=np.random.uniform(0,0.5)
    ...
    dist_x2=np.random.uniform(0,0.5)
    dist_y2=np.random.uniform(0,0.5)
    dist_z2=np.random.uniform(0,0.5)
