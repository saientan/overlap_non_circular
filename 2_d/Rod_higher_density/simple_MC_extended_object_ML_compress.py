...
#f=open('traj.dat','w')
    ...
    for i in range(0,30):
        ...
        mcr=1.21
        for j in range(0,30):
            x,y,theta,L,acc=monte_carlo_move(200,mct,mct,mcr,L,x,y,theta,model,model_name)
            if acc>0.5:
                break
            else:
                if mct>0.2:
        ...
        x,y,theta,L,acc=monte_carlo_move(100000,mct,mct,mcr,L,x,y,theta,model,model_name)
